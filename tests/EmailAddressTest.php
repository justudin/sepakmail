...
namespace SepakMail\Tests;

use SepakMail\EmailAddress;
use PHPUnit\Framework\TestCase;

class EmailAddressTest extends TestCase
{
    private const VALID_TEST_EMAIL = 'hahahaha@yahoo.com';
    private const INVALID_TEST_EMAIL = 'hahahaha--yahoo.com';
    ...
    {
        $this->assertSame('yahoo.com', $this->validEmail->getHostPart());
    }
    ...
    {
        $this->assertSame('hahahaha', $this->validEmail->getNamePart());
    }
